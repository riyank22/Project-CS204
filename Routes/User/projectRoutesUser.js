...
const {joinProject, getEnrolledProjectList, getPublicProjects} = require("../../Controllers/User/projectControllerUser");
const {verifyProject, verifyProjectEnrollment} = require("../../Middlewares/project");

router.route('/all').get(getEnrolledProjectList)

router.route('/publicProjects').get(getPublicProjects)
